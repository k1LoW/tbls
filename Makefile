...
test:
	...
	env AWS_REGION=ap-northeast-1 ./testdata/dynamodb.sh > /dev/null 2>&1
...
doc: build
	...
	env AWS_REGION=ap-northeast-1 AWS_ENDPOINT_URL=http://localhost:18000 ./tbls doc dynamodb://ap-northeast-1 -c testdata/test_tbls_dynamodb.yml -f sample/dynamodb
...
testdoc:
	...
	env AWS_REGION=ap-northeast-1 AWS_ENDPOINT_URL=http://localhost:18000 ./tbls diff dynamodb://ap-northeast-1 -c testdata/test_tbls_dynamodb.yml sample/dynamodb
