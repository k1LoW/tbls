...
require (
	...
	github.com/minio/minio v0.0.0-20200224010911-dcd63b41466e
...
replace github.com/goccy/go-yaml => github.com/k1LoW/go-yaml v1.4.1-0.20200307005032-38cc1a72b58f
