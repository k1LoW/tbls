...
| ---- | ---- | ------- | -------- | ---------------- | -------- | ------- | ------- | ------ |
| id | int(11) |  | false | auto_increment | [user_options](user_options.md) [posts](posts.md) [same_name_constraints](same_name_constraints.md) [comments](comments.md) [comment_stars](comment_stars.md) [logs](logs.md) |  |  |  |
